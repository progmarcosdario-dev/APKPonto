...
async function syncPontoRegistros(): Promise<void> {
  try {
...
function getPendingRecords(db: IDBDatabase): Promise<any[]> {
  return new Promise((resolve, reject) => {
...
function markRecordAsSynced(db: IDBDatabase, id: number): Promise<void> {
  return new Promise((resolve, reject) => {
